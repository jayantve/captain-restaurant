      ...
      <section className="py-16 bg-gray-50">
        ...
        {process.env.NEXT_PUBLIC_NAME} <br />
            ...
            <div className="text-center bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">
                Phone:+91 8810555649 <br />
                Reservations: +91 8810555649 <br />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-2">
                <p className="text-gray-700">
                  <strong>General:</strong> hari@captainrestaurant.com
                </p>
                <p className="text-gray-700">
                  <strong>Reservations:</strong> reservation@captainrestaurant.com
                </p>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-2">
                <p className="text-gray-700">
                  <strong>Main Line:</strong> +91 8810555649
                </p>
                <p className="text-gray-700">
                  <strong>Reservations:</strong> +91 8810555649
                </p>
                <p className="text-gray-700">
